...
public class IA {
	...
	public java.util.ArrayList<esami.ia.pileofballs.ListaSeven> scegliPosizione(java.util.ArrayList<esami.ia.pileofballs.Lista> occupati, java.util.ArrayList<esami.ia.pileofballs.Lista> tripla, java.util.ArrayList<esami.ia.pileofballs.Lista> triplasucc, java.util.ArrayList<esami.ia.pileofballs.Pair> costo, java.util.ArrayList<esami.ia.pileofballs.Tris> libere){
		...
		try{
			...
			_JDLV_PROGRAM_EXECUTING.addText("pos(A,B,C) :- sc(_,I,J,COL), poslibere(I1,J,_), occ(_,I,J1,COL), occ(_,I,J2,_), I1=I-1, J1=J+1, J2=J-1, A=0, B=2, c(C), pari(I)."+'\n');
			_JDLV_PROGRAM_EXECUTING.addText("pos(A,B,C) :- sc(_,I,J,_), poslibere(I1,J,_), poslibere(I,J1,_), poslibere(I,J2,_), I1=I-1, J1=J+1, J2=J-1, A=0, B=1, c(C)."+'\n');
			_JDLV_PROGRAM_EXECUTING.addText("pos(A,B,C) :- sc(_,I,J,_), poslibere(I1,J,_), occ(_,I,J1,_), occ(_,I1,J1,_), I1=I-1, J1=J-1, A=0, B=1, c(C)."+'\n');
